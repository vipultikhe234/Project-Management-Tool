    ...
    <div className="w-full animate-in fade-in duration-500 pb-10">
        ...
        <div className="space-y-2">
          <nav className="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
            ...
            <select 
              ...
              className="bg-transparent text-indigo-600 font-bold text-xs select-none outline-none cursor-pointer border-none p-0"
            >
          ...
          <h1 className="text-2xl font-bold text-slate-800 leading-none mt-2">Active Board</h1>
        </div>

        <div className="flex items-center gap-4">
          <button className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-bold shadow-sm hover:bg-slate-50 transition-all text-slate-600">
      ...
      <div className="flex items-center gap-4 mb-8 bg-white p-2 rounded-xl border border-slate-200 shadow-sm">
        ...
        <div className="ml-auto flex items-center gap-1 pr-2">
          <button className="p-2 text-slate-300 hover:text-indigo-600 rounded-lg"><LayoutGrid className="w-4 h-4" /></button>
          <button className="p-2 bg-indigo-50 text-indigo-600 rounded-lg"><Kanban className="w-4 h-4" /></button>
        </div>
      </div>
