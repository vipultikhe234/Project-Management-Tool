...
export const IssueDetailModal: React.FC<IssueDetailModalProps> = ({ isOpen, onClose, issueUuid }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-5xl bg-white rounded-2xl shadow-2xl flex flex-col h-[90vh] lg:h-[85vh] max-h-[90vh] animate-in zoom-in-95 duration-200 overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="p-1.5 text-slate-400 hover:text-slate-600 rounded-lg hover:bg-slate-100 transition-all"><Lock className="w-4 h-4" /></button>
            <button className="p-1.5 text-slate-400 hover:text-slate-600 rounded-lg hover:bg-slate-100 transition-all"><Eye className="w-4 h-4" /></button>
            <button className="p-1.5 text-slate-400 hover:text-slate-600 rounded-lg hover:bg-slate-100 transition-all"><Share2 className="w-4 h-4" /></button>
            {issue && (
            ...
            <button className="p-1.5 text-slate-400 hover:text-slate-600 rounded-lg hover:bg-slate-100 transition-all"><MoreHorizontal className="w-4 h-4" /></button>
        ...
        <div className="flex-1 overflow-hidden p-8 flex flex-col">
          {loading ? (
            ...
            <div className="grid grid-cols-12 gap-8 items-stretch flex-1 min-h-0 overflow-hidden">
              
              {/* Main Content Area (Scrolls independently) */}
              <div className="col-span-12 lg:col-span-8 overflow-y-auto h-full pr-4 pb-12 space-y-8 scrollbar-none">
                          ...
                          <div className="relative">
                            ...
                            <div className="absolute bottom-3 right-3 flex gap-2">
                              <button 
                                ...
                                className="px-5 py-1.5 bg-indigo-600 text-white rounded-lg text-xs font-black uppercase tracking-widest hover:bg-indigo-700 transition-all disabled:opacity-50"
                              >
              ...
              {/* Sidebar Info Area (Scrolls independently) */}
              <div className="col-span-12 lg:col-span-4 overflow-y-auto h-full pr-2 pb-12 space-y-6 scrollbar-none">
